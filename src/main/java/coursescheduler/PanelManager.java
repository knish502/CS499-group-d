...
public class PanelManager {
  ...
  public PanelManager(
      ...
      createAccountJpanel createAccountInput,
      AddCourseDepartmentChair addCourseDepartmentChairInput,
      AddCoursePageFaculty addCoursePageFacultyInput,
      EditCourse editCoursePageInput,
      RegistrarPage registrarPageInput,
      FacultyPage facultyPageInput,
      DepartmentChairPage departmentChairPageInput,
      RemoveCoursePage removeCourseInput) // Default constructor
      {
